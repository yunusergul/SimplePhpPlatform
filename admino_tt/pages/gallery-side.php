...
if($_GET['side']!='tet1' or $_GET['page']=='tet1'){
echo '<div class="row">
...
<div class="col-6 w3-centered">
	<div  class="w3-padding-60 w3-center">		 
 		<div class="w3-row w3-left-align">
			<div class="row">';
	$querygallery = $db->query("SELECT * FROM gallery WHERE page_id=".$query['id']." and side_id=".$_GET['side']." and on_co=1", PDO::FETCH_ASSOC);
				...
				foreach( $querygallery as $rowgallery){
					...
					<form action="" method="post" enctype="multipart/form-data"></form>
    						...
    						<img src="../projebeta/gallery/'.$rowgallery['gallery_scr'].'" name="gallery_tt" width="300" height="200"><input name="id_gallery" type="text" style="Visibility : hidden;" value="'.$rowgallery['id'].'">	
  							...
  							<div class="desc"><button name="side_gallery_del" class="w3-button w3-red" style="width: 100%;">Sil</button></div>
						</div></from>
						';}}
echo '<div class="gallery w3-center" style="width: auto;">
					...
					<div class="desc"><button type="submit" id="side_gallery_add"  name="side_gallery_add" class="w3-button w3-green" style="width: 100%;">Resim Ekle</button></div></form>
